...
class _OsBiparScreenState extends ConsumerState<OsBiparScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('OS ${widget.numos}'), centerTitle: true),
      body: osAsync.when(
            ...
            Row(
              children: [
                ...
                _buildActionButton(
                  ...
                  'ESTOQUES',
                  Colors.blue,
                  () => _mostrarDialogEstoques(context, os.codprod),
                ),
              ],
            ),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    '${e.predio.toString().padLeft(2, '0')} ',
                                  ),
                                  Text(
                                    '${e.nivel.toString().padLeft(2, '0')} ',
                                  ),
