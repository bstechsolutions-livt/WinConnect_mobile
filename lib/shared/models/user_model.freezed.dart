...
abstract class $AuthTokenCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String type, DateTime expiresAt});
}
...
class _$AuthTokenImpl implements _AuthToken {
  ...
  @override
  String toString() {
    return 'AuthToken(token: $token, type: $type, expiresAt: $expiresAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, type, expiresAt);
...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({User user, AuthToken token});
...
class _$LoginResponseImpl implements _LoginResponse {
  const _$LoginResponseImpl({required this.user, required this.token});
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final AuthToken token}) = _$LoginResponseImpl;
